...
#define TLV_SMARTCONTRACT   0x1F52
...
#define ACCOUNT_CONN_OP     (struct object_op) {METHOD_NEW &account_connections_new, METHOD_FREE &account_connections_free, METHOD_SET &account_connections_set, METHOD_SET &account_connections_copy, METHOD_MARK &account_connections_mark, METHOD_MARK &account_connections_unmark, METHOD_CLEAR &account_connections_clear, METHOD_CMP &account_connections_cmp}
#define ACTIVE_ACC_OP       (struct object_op) {METHOD_NEW &activated_accounts_new, METHOD_FREE &activated_accounts_free, METHOD_SET &activated_accounts_set, METHOD_SET &activated_accounts_copy, METHOD_MARK &activated_accounts_mark, METHOD_MARK &activated_accounts_unmark, METHOD_CLEAR &activated_accounts_clear, METHOD_CMP &activated_accounts_cmp}
#define BLOCK_OP            (struct object_op) {METHOD_NEW &block_new, METHOD_FREE &block_free, METHOD_SET &block_set, METHOD_SET &block_copy, METHOD_MARK &block_mark, METHOD_MARK &block_unmark, METHOD_CLEAR &block_clear, METHOD_CMP &block_cmp}
#define BLOCK_HISTORY_OP    (struct object_op) {METHOD_NEW &block_history_new, METHOD_FREE &block_history_free, METHOD_SET &block_history_set, METHOD_SET &block_history_copy, METHOD_MARK &block_history_mark, METHOD_MARK &block_history_unmark, METHOD_CLEAR &block_history_clear, METHOD_CMP &block_history_cmp}
