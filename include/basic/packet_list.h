...
int8_t packet_list_cmp(const struct packet_list_st *, const struct packet_list_st *);
...
// Cmp Methods
int8_t packet_list_is_null(const struct packet_list_st *);
void packet_list_resize(struct packet_list_st *, size_t);

// TLV Methods
int8_t packet_list_set_tlv(struct packet_list_st *, const struct string_st *);
